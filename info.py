...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'kung fu panda')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>Title 🎬: <code>{file_name}kung fu panda</code>\n Size : <i>{file_size}</i>\n\n</b><b>ನೀವು ಇತರ ಚಲನಚಿತ್ರಗಳನ್ನು ಕೇಳಲು ಬಯಸಿದರೆ, ನೀವು ಗುಂಪಿನಲ್ಲಿ ಕೇಳಬಹುದು\n👇👇👇\n\n</b><b>Panda [Link](https://t.me/KungFuPanda_Robot)\t\n\n</b>")
