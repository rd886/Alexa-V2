...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📝 File Name :<code>[@KungFuPanda_Robot]\n{file_name}</code>\n\n</b>🧲 File Size : <i>{file_size}</i>\n[➕ Add Me To Your Groups ➕](buttonurl://https://t.me/KungFuPanda_Robot?startgroup=true)")
