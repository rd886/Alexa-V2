...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/rd886/Alexa-V2/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 ᴜᴘᴅᴀᴛᴇ 💠', url='https://t.me/KungFuPanda_Robot'),
            InlineKeyboardButton('💠 ᴍᴏᴠɪᴇs 💠', url='tg://settings')
            ],[      
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑼𝒑𝒅𝒂𝒕𝒆 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑨𝒏𝒅 𝑻𝒓𝒚 𝑨𝒈𝒂𝒊𝒏 𝑻𝒐 𝑮𝒆𝒕 𝑴𝒐𝒗𝒊𝒆 𝑭𝒊𝒍𝒆𝒔!**",
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/rd886/Alexa-V2/commit/f3d2a1bcb155faf44178e5d7a685a1b533e714bf#diff-86b613edf1748372103e94cacff3b578b36b698ef9c16817bb98fe9ef22fb669R39 
